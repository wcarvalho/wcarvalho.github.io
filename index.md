...
1. How do we discover and encode this predictive knowledge using rich sensory observations of a large and continuously evolving world?
2. How do we exploit this predictive knowledge to make effective plans, combine our known behaviors, and coordinate with other social agents?

Currently, I am a research fellow in Harvard's [Kempner Institute for the Study of Natural and Artificial Intelligence](https://www.harvard.edu/kempner-institute/). To think about these questions, I aim to draw from deep learning and reinforcement learning to develop algorithmic theories for how humans learn and generalize. While my training is in machine learning, I hope to collaborate broadly with neuroscientists and cognitive scientists. Please reach out!
...
I aim to characterize the human mind's learning algorithms. To do so, I draw from and advance methods in machine learning, with an emphasis on deep reinforcement learning. If you find this interesting, please reach out. I am always open to working with new motivated students. **As a member of groups underrepresented in research and academia, I especially encourage members of marginalized groups to reach out.**
